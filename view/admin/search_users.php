<?php
    ...
    if(isset($_POST['search']))
    {
        ...
        $list = $_POST['search-user-list'];
    }
    else{
        echo "<script>alert('errorquery.'); window.location.href='users.php';</script>";
            exit();
    }
            ...
            <div class="display-data-users">
                <div class="display-users">
                    <table>
                        ...
                        <?php
                        $select_user_query = "SELECT * FROM `user` WHERE role = 'Member' AND CONCAT(first_name,last_name,email,created_at) LIKE '%$searchtxt%' 
                        ORDER BY '$list' ";
